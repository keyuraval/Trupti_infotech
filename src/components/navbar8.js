                ...
                <div className="navbar8-menu-item5">
                  ...
                  <div className="navbar8-content5">
                    <span className="navbar8-page12 thq-body-large">
                      {props.page1 ?? (
                        <Fragment>
                          <span className="navbar8-text17">index.html</span>
                        </Fragment>
                      )}
                    </span>
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    <span className="navbar8-page22 thq-body-large">
                      {props.page2 ?? (
                        <Fragment>
                          <span className="navbar8-text20">services.html</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text25">portfolio.html</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text19">contact.html</span>
                        </Fragment>
                      )}
                    </span>
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:'https://images.unsplash.com/ph?oto-1551419762-4a3d998f6292?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NzIxODA1Nnw&ixlib=rb-4.1.0&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'Services Image',
  link2: undefined,
  linkUrlPage2: '',
  logoAlt: 'Trupti Infotech',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1594904351111-a072f80b1a71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NzIxODA1Nnw&ixlib=rb-4.1.0&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1573164574397-dd250bc8a598?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NzIxODA1N3w&ixlib=rb-4.1.0&q=80&w=1080',
